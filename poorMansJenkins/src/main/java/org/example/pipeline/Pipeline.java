...
public final class Pipeline<I, O> {
    ...
    public static <I, O> Pipeline<I, O> start(Stage<I, O> initialStage) {
        if (initialStage == null) {
            throw new IllegalArgumentException("Pipeline's initialStage is null");
        }
     ...
     * @return this pipeline instance cast to a pipeline producing
     * @throws IllegalArgumentException if the stage passed to addStage is null
     */
    @SuppressWarnings("unchecked")
    public <NEW_O> Pipeline<I, NEW_O> addStage(Stage<? super O, NEW_O> stage) {
        if (stage == null) {
            throw new IllegalArgumentException("Cannot add null stage to pipeline");
        }
