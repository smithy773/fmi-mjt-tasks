package org.example.pipeline.stage;
...
public final class Stage<I, O> {
    ...
    public static <I, O> Stage<I, O> start(Step<I, O> initialStep) {
        if (initialStep == null) {
            throw new IllegalArgumentException("Stage's initialStep cannot be null");
        }
    ...
    public <NEW_O> Stage<I, NEW_O> addStep(Step<? super O, NEW_O> step) {
        if (step == null) {
            throw new IllegalArgumentException("Step passed to add method is null");
        }
